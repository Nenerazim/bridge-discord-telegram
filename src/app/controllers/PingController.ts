import { DiscordMessageLoggerUseCase } from 'app/domain/useCase/UseCasePingDiscord.ts';
import {UseCasePingTelegram} from 'app/domain/useCase/UseCasePingTelegram.ts';
